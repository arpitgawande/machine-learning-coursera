...
%Adding Bias in input layer a1
a1 = [ones(m,1) X];
% a2 = g(z(2)) ..where g is sigmoid function
a2 = sigmoid(a1 * Theta1'); % a1 * Theta1' -> z(2) ... sigmoid(z(2)) -> g(z(2)) -> a2
% Adding bias
a2 = [ones(size(a2,1),1) a2];
% a(3) = g(z(2)) = h(θ)d
a3 = sigmoid(a2 * Theta2'); % a1 * Theta2' -> z(3) ... sigmoid(z(3)) -> g(z(3)) -> a3
%
%y_dash = zeros(size(y,1), size(a3,1));
% Final prediction: Un-Regularized cost function
for i = 1:size(a3,2)
	%y_dash = (y' == i);
